                ...
                <div style={{ display: 'grid', gap: '16px', marginBottom: '24px' }}>
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px', background: 'rgba(255,255,255,0.03)', borderRadius: '10px' }}>
                        ...
                        <label style={{ position: 'relative', display: 'inline-block', width: '50px', height: '28px' }}>
                            <input
                                type="checkbox"
                                checked={settings.merch_coming_soon === 'true' || settings.merch_coming_soon === true}
                                onChange={(e) => updateSetting('merch_coming_soon', e.target.checked)}
                                style={{ opacity: 0, width: 0, height: 0 }}
                            />
                            <span style={{
                                position: 'absolute', cursor: 'pointer', top: 0, left: 0, right: 0, bottom: 0,
                                backgroundColor: (settings.merch_coming_soon === 'true' || settings.merch_coming_soon === true) ? '#9333ea' : 'rgba(255,255,255,0.1)',
                                transition: '.4s', borderRadius: '34px'
                            }}>
                                <span style={{
                                    position: 'absolute', content: '""', height: '20px', width: '20px', left: '4px', bottom: '4px',
                                    backgroundColor: 'white', transition: '.4s', borderRadius: '50%',
                                    transform: (settings.merch_coming_soon === 'true' || settings.merch_coming_soon === true) ? 'translateX(22px)' : 'translateX(0)'
                                }} />
                            </span>
                        </label>
                    </div>
